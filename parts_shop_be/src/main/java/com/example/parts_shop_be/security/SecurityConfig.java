...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    //todo adjust
    public static final String[] PUBLIC_URLS = {"/user/test", "/api/login", "/api/v1/token/refresh", "/user/email-exists/*", "/user/email-exists-pass-reset/*", "/user/register", "/user/signup-confirmation/*", "/user/reset-password", "/user/forgot-password-confirmation/*", "/products/*", "/products"};//, "/api/v1/user/all"
