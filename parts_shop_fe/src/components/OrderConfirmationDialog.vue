      ...
      <q-card-section>
        <div class="tw-flex tw-flex-col tw-items-start full-width">
          ...
          <p class="text-h6 q-mb-md">
            {{ $t('checkout.total') }}: {{ formatPrice(details.total) }}
          </p>

          <div class="q-mb-md">
            <strong>{{ $t('checkout.shippingDetails') }}:</strong>
            <p class="q-mb-none">{{ form.shipping.firstName }} {{ form.shipping.lastName }}</p>
            <p class="q-mb-none">{{ form.shipping.email }}</p>
            <p class="q-mb-none">{{ form.shipping.address }}</p>
          </div>
