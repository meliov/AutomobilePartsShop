<template>
  <q-page
    padding
    class="tw-max-w-md tw-mx-auto tw-flex tw-flex-col tw-justify-center tw-items-center tw-gap-4"
  >
    <PageInfoText :description="$t('thankYou.subtitle')" />
